...
export function TvShowFilters({ initialGenres }: TvShowFiltersProps) {
  ...
  const SORT_OPTIONS = [
    ...
    { id: "first_air_date.desc", name: tFilters("sort_date_desc") },
    { id: "first_air_date.asc", name: tFilters("sort_date_asc") },
    { id: "name.desc", name: tFilters("sort_title_desc") },
    { id: "name.asc", name: tFilters("sort_title_asc") },
  ];
