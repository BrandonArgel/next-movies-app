...
export function GET(request: Request) {
  ...
  const svgString = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" width="100%" height="100%">
      ...
      <g clip-path="url(#bucket-clip)">
        <rect x="0" y="225" width="500" height="300" fill="#E6E6E6" />
        <rect x="43" y="225" width="36" height="300" fill="${color}" />
        <rect x="115" y="225" width="36" height="300" fill="${color}" />
        <rect x="187" y="225" width="36" height="300" fill="${color}" />
        <rect x="259" y="225" width="36" height="300" fill="${color}" />
        <rect x="331" y="225" width="36" height="300" fill="${color}" />
      </g>
      ...
      <g>
        <polygon points="410,280 425,280 425,180 410,180" fill="${color}" />
        <polygon points="410,280 425,280 425,180 410,180" fill="#000" fill-opacity="0.15" />
        <polygon points="410,180 425,180 445,130 430,130" fill="${color}" />
      </g>

      <g clip-path="url(#cup-clip)">
        <rect x="300" y="310" width="200" height="200" fill="${color}" />
        <polygon points="300,370 500,400 500,450 300,420" fill="#000" fill-opacity="0.15" />
      </g>
